...
public class PasswordDialog extends JDialog {
    ...
    public PasswordDialog(UserData userData) {

        setIconImage(sqlConnect.icon.getImage());
        ...
        button.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                String md5OldPassword = sqlConnect.createMD5Password(oldPassword);

                if (md5OldPassword.equals(sqlConnect.user.getPassWord())) {
                    if (newPassword.isEmpty()) {
                        ...
                        if (isOk == 0) {
                            userData.editPassword(sqlConnect.user, newPassword);
